...
public interface IMenuBuilder
{
    ...
    /// <summary>
    /// Builds and finalizes the menu configuration.
    /// Returns a string representation of the built menu or configuration result.
    /// </summary>
    /// <returns>A string representing the built menu or build result.</returns>
    string Build();
}
